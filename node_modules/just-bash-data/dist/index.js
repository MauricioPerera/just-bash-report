...
import { EncryptedAdapter, DocStore, Auth } from 'js-doc-store';
import { VectorStore, BinaryQuantizedStore, PolarQuantizedStore, QuantizedStore, IVFIndex } from 'js-vector-store';
...
var buildDbCommand = (provide) => defineCommand(
  "db",
...
var buildVecCommand = (provide) => defineCommand(
  "vec",
  async (args, ctx) => runCommand(async () => {
    const reg = provide(ctx.fs);
...
var buildSentinel = (tool, coll) => defineCommand(`${tool}.${coll}`, async () => ({
  stdout: "",
...
var PluginRegistry = class {
  ...
  async setupEncryption() {
    ...
    this.encReady = (async () => {
      this.encJson = userSalt !== void 0 ? await EncryptedAdapter.create(
        this.mem,
...
export { createDataPlugin, sentinelNames };
